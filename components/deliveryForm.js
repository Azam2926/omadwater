...
export default function DeliveryForm() {
  ...
  return isSubmitSuccessful ? (
    ...
    <form className={'grid items-center space-y-4'} onSubmit={handleSubmit(sendForm)}>
      <input {...register('ismi', {pattern: /^[A-Za-z']+$/i, required: true, maxLength: 20})} className={'focus:ring-2 ring-blue-500 outline-none py-3 px-6 border rounded-full mx-auto w-full'} required type="text" placeholder={'Ismingiz'}/>
