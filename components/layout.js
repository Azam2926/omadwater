...
export default function Layout({children}) {
  ...
  return (
    <>
      <nav className={`p-4 flex flex-wrap items-start text-[#081F46] ${isOpen
        ? 'fixed z-50 bg-white inset-0'
        : ''
      }`}>
        <div className="flex flex-wrap w-full">
          ...
          <div className={`grid w-full ${isOpen ? '' : 'hidden'}`}>
            ...
            <div className="flex order-[-1] text-xs m-4 mt-3 font-semibold tracking-[1px]">
              ...
              <div className="flex">
                <a href="tel:+998990981375"
                   className={'flex flex-wrap items-center justify-center content-center my-3'}>
                  <p>+998 99 0981375</p>
